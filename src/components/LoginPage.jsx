        ...
        <Container className='loginbg d-flex justify-content-center align-items-center' fluid>
            <Row>
                <Col>
                    ...
                    <Card style={{
                        width: '500px', height: '500px', border: '1.5px solid #fff',
                    ...
                    >
                        <Card.Body>
                                ...
                                <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                                    ...
                                    <div className='text-end pt-2'>
                                        <Link to={'/forgotpassword'}>
                                            <span><a href="" className='text-decoration-underline' style={{ color: "#43495B" }}>Forget Password?</a></span>
                                        </Link>
                                    </div>
                                </Form.Group>
                            </Form>
                            ...
                            <div className='text-center pt-2 pb-5'>
                                <span><a href="" className='text-decoration-none' style={{ color: "#43495B" }}>Don’t have an account?
                                    <Link to={'/signup'}>
                                        <span className='text-decoration-underline' style={{ color: "#43495B" }}>Sign up</span>
                                    </Link>
                                </a>
                                </span>
                            </div>
